...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET JsonCpp::JsonCpp
                 ...
                 $<$<CONFIG:Release>:${jsoncpp_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET JsonCpp::JsonCpp
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${jsoncpp_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET JsonCpp::JsonCpp
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${jsoncpp_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET JsonCpp::JsonCpp
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${jsoncpp_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET JsonCpp::JsonCpp
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${jsoncpp_COMPILE_OPTIONS_RELEASE}> APPEND)
