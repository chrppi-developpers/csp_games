...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET libuuid::libuuid
                 ...
                 $<$<CONFIG:Release>:${util-linux-libuuid_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET libuuid::libuuid
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${util-linux-libuuid_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET libuuid::libuuid
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${util-linux-libuuid_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET libuuid::libuuid
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${util-linux-libuuid_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET libuuid::libuuid
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${util-linux-libuuid_COMPILE_OPTIONS_RELEASE}> APPEND)
